...
def upgrade() -> None:
    ...
    op.alter_column('cat_photos', 'media_path',
    ...
    op.alter_column('cats', 'description',
               existing_type=sa.VARCHAR(length=2000),
               type_=sa.String(length=200),
               existing_nullable=True)
    op.drop_constraint('cats_user_id_fkey', 'cats', type_='foreignkey')
    op.create_foreign_key(None, 'cats', 'user', ['user_id'], ['id'], ondelete='SET NULL')
    ...
    op.alter_column('documents', 'name',
               ...
               existing_nullable=False)
    op.alter_column('hero', 'title',
               existing_type=sa.VARCHAR(length=200),
               type_=sa.String(length=120),
               existing_nullable=False)
    op.alter_column('hero', 'sub_title',
               existing_type=sa.VARCHAR(length=200),
               type_=sa.String(length=120),
               existing_nullable=False)
    op.alter_column('hero', 'left_text',
               existing_type=sa.VARCHAR(length=200),
